...
class Theme {
	...
	function widgets() {
		...
		require_once (THEME_WIDGETS . '/calendar.php');
		require_once (THEME_WIDGETS . '/featured-image.php');
		...
		register_widget('Theme_Widget_Calendar');
		unregister_widget('WP_Widget_Calendar');
		register_widget('Theme_Widget_Featured_Image');
	...
	function admin_bar_menu(){
		...
		if(!current_user_can('edit_theme_options')){
		 ...
		 global $wp_admin_bar;
		 if (get_template_directory() === get_stylesheet_directory()) $child=''; else $child= ' Child';
		 $wp_admin_bar->add_menu( array(
			'parent' => false,
			'id' => THEME_SLUG,
			'title' => '<span class="ab-icon"></span><span class="ab-label">' . THEME_NAME .$child. '</span>',
