		...
		$options =  array(
			...
			array(
				...
				"options" => array(
					...
					array(
						"name" => __("Featured Header Keep Global Set Background Image",'theme_admin'),
						"desc" => __('If you set a background color and you want to keep the globally configured background image for this element loaded, then switch this setting on. This is only usefull when you are using a globally configured background image that has transparency and you just want to show that same image with a different background color. The moment you set a background image below, turning On this setting is useless. If set to OFF the above set background color will show and the globally configured background image will be kicked out, unless a background image is set for this element down below.','theme_admin'),
						"id" => "_feature_keep_global_image",
						"label" => "Switch off to kickout the global set background image.",
						"default" => false,
						"type" => "toggle"
					),
					...
					array(
						"name" => __("Page Keep Global Set Background Image",'theme_admin'),
						"desc" => __('If you set a background color and you want to keep the globally configured background image for this element loaded, then switch this setting on. This is only usefull when you are using a globally configured background image that has transparency and you just want to show that same image with a different background color. The moment you set a background image below, turning On this setting is useless. If set to OFF the above set background color will show and the globally configured background image will be kicked out, unless a background image is set for this element down below.','theme_admin'),
						"id" => "_page_keep_global_image",
						"label" => "Switch off to kickout the global set background image.",
						"default" => false,
						"type" => "toggle"
					),
					...
					array(
						"name" => __("Footer Keep Global Set Background Image",'theme_admin'),
						"desc" => __('If you set a background color and you want to keep the globally configured background image for this element loaded, then switch this setting on. This is only usefull when you are using a globally configured background image that has transparency and you just want to show that same image with a different background color. The moment you set a background image below, turning On this setting is useless. If set to OFF the above set background color will show and the globally configured background image will be kicked out, unless a background image is set for this element down below.','theme_admin'),
						"id" => "_footer_keep_global_image",
						"label" => "Switch off to kickout the global set background image.",
						"default" => false,
						"type" => "toggle"
					),
...
<code>&lt;script type=&quot;text/javascript&quot;&gt;alert("hello world");&lt;/script&gt;</code>','theme_admin'),site_url()),
						"id" => "_custom_js",
						"default" => "",
						'rows' => '10',
						"type" => "textarea"
