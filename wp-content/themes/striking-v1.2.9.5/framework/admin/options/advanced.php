		...
		$options = array(
			array(
				...
				"options" => array(
					...
					array(
						"name" => __("Minify Theme CSS & Custom CSS",'theme_admin'),
						"desc" => __("<p>Enable this setting and the CSS created by the settings and the CSS in the Custom CSS field in the global settings or Custom CSS field in the Theme Page Options (including custom CSS in the page options of any preset) will be minified. This also applies to the skin.css. Some of the CSS will be minified on page load as they are dynamic CSS. Note: If CSS like this #page h2 becomes #pageh2 then check your custom css adjustments as there is more then one space between the elements in that case there are two or more spaces between #page and the h2 tag.</p> ",'theme_admin'),
						"id" => "theme_minify",
						"default" => true,
						"type" => "toggle"
					),
					array(
						"name" => __("Minify Theme JS & Custom JS",'theme_admin'),
						"desc" => __("<p>Enable this setting  and the JS Scripts created by the settings and the scripts added in the Custom JS field in the global settings or Custom JS field in the Theme Page Options (including custom JS in the page options of any preset) will be minified. If the JS Minify script generates a JS error after minify is turned ON then turn OFF this setting and report the issue to the support forum.</p> ",'theme_admin'),
						"id" => "theme_minify_js",
						"default" => false,
						"type" => "toggle"
					),
					...
					array(
						"name" => __("Use Gutenberg Editor",'theme_admin'),
						"desc" => __("<p>Normally left OFF as we do not support the Gutenberg Editor in our Theme. But if you want to use it turn this setting ON.</p>",'theme_admin'),
						"id" => "use_gutenberg_editor",
						"default" => false,
						"type" => "toggle"
					),
					array(
...
Single Product image - 294px x custom height<br />
...
<strong>Together the theme options and customizing abilities provide for unlimited ability to display varied content and appearence for a store built using Woo, with unique colors, backgrounds, sliders, and any particular content desired to reinforce the product story and sales process.<br /><br />Check out the theme support forum for the Woo section which ncludes a list of compatible woo plugins, most of which are known to work in the theme.</strong>", 'theme_admin'),
				"options" => array(
					...
					array(
						...
						"id" => "woocommerce",
						"desc"=>__("Enable this setting to declare WooCommerce compatibility and enable the theme Woo related settings. <strong>Note: When this setting is enabled a sidebar set in the sidebar settings below is respected. Otherwise it follows the settings in the default sidebar settings and the global woocommerce sidebar settings are ignored.</strong> &nbsp;VERY IMPORTANT: Please scroll to the General Tab above and enable the 'Use Complex CSS Class' setting as the Woo Plugin uses css styling and classes normally reserved for themebuilders, and so this setting activates an alternate group of css classes so that there are no theme/plugin styling clashes.",'theme_admin'),
					...
					array(
						"name" => __("Show Shop Title in Shop Page Content",'theme_admin'),
						"id" => "woocommerce_shop_title",
						"desc"=>__("Enable this setting to show the shop title above the products in the page that has been assigned as your shop page.",'theme_admin'),
						"default" => false,
						"type" => "toggle"
					),
					array(
						"name" => __("Show Shop Page Title in Browser Tab",'theme_admin'),
						"id" => "woocommerce_shop_title_in_browser_tab",
						"desc"=>__("Enable this setting to show the shop title, as set in the shop page, in the browser tab. <strong>Note: This setting won't work when a seo plugin is active.</strong>",'theme_admin'),
						"default" => true,
						"type" => "toggle"
					),
					array(
						"name" => __("Show Shop Page Body Content In Paginated Pages",'theme_admin'),
						"id" => "woocommerce_show_shop_content_all",
						"desc"=>__("Enable this setting to show any content that is added in the shop page body content on each paginated subpage of the shop page. Woocommerce by default only shows added body content on the first shop page and ignores that content in the shop page on paginated pages (paged=2, paged=3, etc).",'theme_admin'),
						"default" => false,
						"type" => "toggle"
					),
					array(
					...
					array(
						"name" => __("Use Woo 3.0 Single Product Image Layout",'theme_admin'),
						"id" => "woocommerce_spi_layout",
						"desc"=>__('Enable this setting to activate the Woocommerce Single Product Image Layout with Zoom and Lightbox Icon (only available in Woo 3.0). Note: Our on the fly Image resizing, lightbox and thumbnails are disabled. One need to set propper sized image width and height values in the woo settings to not have blurry images.  <a href="https://docs.woocommerce.com/document/fixing-blurry-product-images/" target="_blank">Fixing Blurry Product Images</a>','theme_admin'),
						"default" => false,
						"type" => "toggle",
					),
					array(
						"name" => __("Use Woo 3.0 Single Product LightBox",'theme_admin'),
						"id" => "woocommerce_use_lightbox",
						"desc"=>__('Enable this setting to activate the Woocommerce Single Product Image Lightbox Icon and Lightbox Popup ability (only available in Woo 3.0). This setting only works together with the previous setting. When turned off there is no lightbox popup for the Woo Single Product Image using the new Woocommerce Single Product Layout. The theme Single Product lightbox will still work. But for that you need to turn OFF the Use Woo 3.00 Single Product Image Layout setting.','theme_admin'),
						"default" => true,
						"type" => "toggle",
					...
					array(
						"name" => __("WooCommerce Primary button Background Hover Color",'theme_admin'),
						"desc" => "",
						"id" => "woocommerce_button_hover_color",
						"default" => "",
						"type" => "color"
					),
					array(
						"name" => __("WooCommerce Primary button Text Hover Color",'theme_admin'),
						"desc" => "",
						"id" => "woocommerce_button_text_hover_color",
						"default" => "#ffffff",
						"type" => "color"
					),
					array(
					...
					array(
						"name" => __("WooCommerce Secondary button Background Hover Color",'theme_admin'),
						"desc" => "",
						"id" => "woocommerce_button_secondary_hover_color",
						"default" => "",
						"type" => "color"
					),
					array(
						"name" => __("WooCommerce Secondary button Text Hover Color",'theme_admin'),
						"desc" => "",
						"id" => "woocommerce_button_secondary_text_hover_color",
						"default" => "#ffffff",
						"type" => "color"
					),
					array(
						"name" => __("WooCommerce Shop Sidebar",'theme_admin'),
						"desc" => sprintf(__("Select the custom sidebar that you'd like to be displayed on Shop page.<br />Note: you will need to <a href=\"%s\">create a custom sidebar</a> first. Default = Blog Sidebar.",'theme_admin'),admin_url( 'admin.php?page=theme_sidebar')),
						"id" => "woocommerce_shop_sidebar",
						"prompt" => __("Use default",'theme_admin'),
						"default" => '',
					...
					array(
						...
						"desc" => __("Select the custom sidebar that you'd like to be displayed on Product page. Default = Blog Sidebar.",'theme_admin'),
					...
					array(
						...
						"desc" => __("Select the custom sidebar that you'd like to be displayed on Product Category page. Default = Blog Sidebar.",'theme_admin'),
					...
					array(
						...
						"desc" => __("Select the custom sidebar that you'd like to be displayed on Product Tag page. Default = Blog Sidebar.",'theme_admin'),
					...
					array(
						"name" => __("Image Hover Icon for Shop / Category / Upsell / Cross-sell / Related",'theme_admin'),
						"desc"=>__("Set the Icon to show on hovering the image in the Shop Page, Category pages, Upsell, Cross-sell or related products. ",'theme_admin'),
						"id" => "woocommerce_global_hover_icon",
						"default" => 'link',
						"options" => array(
							"none" => __('Disable Hover Icon','theme_admin'),
							"link" => __('Show Link Icon','theme_admin'),
							"doc" => __('Show Document Icon','theme_admin'),
							"zoom" => __('Show Zoom Icon','theme_admin'),
						),
						"type" => "select",
					),
					array(
						"name" => __("Image Hover Icon for Single Product Page",'theme_admin'),
						"desc"=>__("Set the Icon to show on hovering the single product image and thumbnails. ",'theme_admin'),
						"id" => "woocommerce_single_hover_icon",
						"default" => 'zoom',
						"options" => array(
							"none" => __('Disable Hover Icon','theme_admin'),
							"zoom" => __('Show Zoom Icon','theme_admin'),
					...
					array(
						"name" => __("Shop Image Size Width",'theme_admin'),
						"desc"=>__("Set the width for the Shop Page Image. Default=219.",'theme_admin'),
						"id" => "woocommerce_shop_image_width",
						"min" => "50",
						"max" => "1000",
						"step" => "1",
						"default" => "219",
					...
					array(
						"name" => __("Shop Image Size Height",'theme_admin'),
						"desc"=>__("Set the height for the Shop Page Image. Default=219",'theme_admin'),
						"id" => "woocommerce_shop_image_height",
						"min" => "50",
						"max" => "1000",
						"step" => "1",
						"default" => "219",
					...
					array(
						"name" => __("Shop Image Crop",'theme_admin'),
						"id" => "woocommerce_shop_image_crop",
						"desc"=>__('Turn ON/OFF cropping for the Shop Page Image. Default=OFF','theme_admin'),
						"default" => false,
						"type" => "toggle",
					),
					array(
						"name" => __("Single Image Size Width",'theme_admin'),
						"desc"=>__("Set the width for the Single Product Image. Default=294",'theme_admin'),
					...
					array(
						"name" => __("Single Image Size Height",'theme_admin'),
						"desc"=>__("Set the height for the Single Product Image. Default=294",'theme_admin'),
						"id" => "woocommerce_single_image_height",
						"min" => "50",
						"max" => "1000",
						"step" => "1",
						"default" => "294",
					...
					array(
						"name" => __("Single Image Crop",'theme_admin'),
						"id" => "woocommerce_single_image_crop",
						"desc"=>__('Turn ON/OFF cropping for the Single Product Image. Default=ON','theme_admin'),
						"default" => true,
						"type" => "toggle",
					),
					array(
						"name" => __("Thumbnail Image Size Width",'theme_admin'),
						"desc"=>__("Set the width for the Product Thumbnail Image. Default=91.",'theme_admin'),
					...
					array(
						"name" => __("Thumbnail Image Size Height",'theme_admin'),
						"desc"=>__("Set the height for the Product Thumbnail Image. Default=91",'theme_admin'),
						"id" => "woocommerce_thumbnail_image_height",
						"min" => "50",
						"max" => "1000",
						"step" => "1",
						"default" => "91",
					...
					array(
						"name" => __("Thumbnail Image Crop",'theme_admin'),
						"id" => "woocommerce_thumbnail_image_crop",
						"desc"=>__('Turn ON/OFF cropping for the Product Thumbnail Image. Default=OFF','theme_admin'),
						"default" => false,
						"type" => "toggle",
					),
				),
...
<b>B)</b> &nbsp;Another setting <b>Fit To View</b> when toggled OFF will allow all images to show full size when displayed in the lightbox. &nbsp;See the setting for more information.</p>", 'theme_admin'),
			...
			array(
				...
				"options" => array(
					...
					array(
						"name" => __("Enable shortcode for the excerpt in search result pages",'theme_admin'),
						"desc" => __("If this option is ON, it will enable shortcode support for the excerpt in search pages.",'theme_admin'),
						"id" => "search_excerpt_shortcode",
						"default" => false,
						"type" => "toggle"
					),
					array(
						"name" => __("Strip Shortcodes from search result pages",'theme_admin'),
						"desc" => __("If this option is ON, it will remove the shortcodes from the excerpt in the search result pages. This only works when Enable Shortcode for excerpt and Display Full Blog Posts (previous two setting) are turned OFF. Note: Only applies to the real excerpt. Not the excerpt generated from the content when no excerpt has been added.",'theme_admin'),
...
<p><b>HINT:</b> &nbsp;&nbsp;Combining the options below with the ability to assign each archive a custom sidebar (settings for this are found in the Sidebar Panel) will allow each website to provide for targeted and customized content by archive type.</p>", 'theme_admin'),
		...
		$options = array_merge($options , array(
			...
			array(
				"slug" => 'superlink',
				"name" => __("Superlink Administration",'theme_admin'),
				"desc" => __("<p>The first thing to know is that the settings below are mainly applicable for users who:</p>
				<p><b>A)</b> are on hosting (typically inexpensive hosting plans) where they have low resource limits, in particular low available memory, AND</p>
				<p><b>B)</b> you have a website where the sum of posts/pages/categories is several hundred or more items in total.<p>
				<p>If you have say 200-300 items of all kinds or less, very likely you did not need to utilize any of the settings in this Superlinks administration.<p>
				<p>In Portfolio post or a Slider Item creation/editing, among your settings are options to link the featured image, and read more buttons to other content in your website. We call this ability a &#34;Superlink&#34; as behind the scenes we use code to build on-demand a  list (in programmer talk we term this an &#34;array&#34;) of all posts/pages/portfolio/categories items in a dropdown from which you can select your desired target to link. In this instance its a &#34;super&#34; list due to the variety and amount of items listed in the array.</p>
				<p>However, the on-demand creation of the superlink list, when you have hundreds or more individual choices, can consume a significant amount of memory. And for editing portfolio items, this list is assembled twice as 2 different settings provide superlinking options. If you are on a host which has low memory values and you have a large number of items, the server can run out of memory while attempting to create the superlinks, and so the portfolio or slider edit panel will fail to display properly, or it will load but be inoperable.</p>
				<p>With the settings below you can restrict the size of the list, and sort it according to various criteria (which also impact the list outcome) with the list size range of -1 to 1000. &nbsp;-1 is a default value which results in all your pages/posts and categories displayed.  However, if the amount of website content is such that the edit panels are experiencing impairment, or you just find the list length impractical then it can be limited with a maximum length of 1000 items.</p>
				<p>Even if restricting the superlink via the options below it is still very easy to link to non-listed items simply by use of the <i>Link Manually</i> option in the linking setting, and insert the full url to the desired webpage in the blank field that appears when Link Mannually is selected.</p>
				<p>The settings below apply to limiting the amount of blog and portfolio posts that can appear as part of a list.  Usually pages and categories make up only a small fraction of the total potential items for a superlink.  A website might have 15 pages, but 500 blog or portfolio posts, hence the settings below pertain to posts only at this time.</p>
				<p><b>EXPERT TIP:</b> Sometimes it is possible to increase the allowable memory for the website via a line of code inserted into the wp-config file in the website root.  Try to increase the memory value in the wp-config.php by adding a line as follows:<br><br>
				define('WP_MEMORY_LIMIT', '256M'); <br></p>
				<p>After adjustment should the edit panel still not function properly then use the Superlink settings. Another option is to contact your host and determine if they are able to increase your available memory - often you have to upgrade your plan to obtain a better memory value.</p>",'theme_admin'),
				"options" => array(
					array(
						"name" => __("Number Of Blog Items in Superlink Lists",'theme_admin'),
						"desc" => __("When set to -1 all blog posts are shown as part of the list. The range setting allows including (or limiting) -1 (all) to 1000 (maximum) posts.",'theme_admin'),
						"id" => "superlink_max_posts",
						"default" => '-1',
						"min" => -1,
						"max" => 1000,
						"step" => "1",
					...
					array(
						"name" => __("Order Blog Posts By",'theme_admin'),
						"desc" => __("<p align='justify'>Select and set the blog post sorting order for how they appear in a superlink. The options are by date, id, title, date modified or Author. &nbsp;You should be aware that choosing any option other then Date Created will result in an ordering that will not necessarily have the most recent posts appearing in the Superlink. &nbsp;But if you have say a multi-author website and have given users editor or unique priveleges (User Role Editor Plugin) then other sort orders could be very applicable.</p>",'theme_admin'),	
						"id" => "superlink_orderby_posts",
						"default" => 'title',
						"options" => array(
							"date" => __('Date Created','theme_admin'),
							"ID" => __('ID','theme_admin'),
							"title" => __('Title','theme_admin'),
							"modified" => __('Date Modified','theme_admin'),
							"author" => __('Author','theme_admin'),
						),
						"type" => "select",
					),
					array(
						"name" => __("Ascending or Descending Post Sort",'theme_admin'),
						"desc" => __("You can choose ASC or DESC. Note when set to DESC and <i>Order Blog Posts By</i> is set to Date the Superlink will list blog posts starting from the oldest created post. When set to ASC and Date posts, the Superlink field will list the blog posts starting from the most recent post created.",'theme_admin'),	
						"id" => "superlink_order_posts",
						"default" => 'ASC',
						"options" => array(
							"DESC" => __('Descending','theme_admin'),
							"ASC" => __('Ascending','theme_admin'),
						),
						"type" => "select",
					),
					array(
						"name" => __("Number Of Portfolio Items in Superlink Lists",'theme_admin'),
						"desc" => __("When set to -1 all Portfolio posts are shown in the Superlink list. The range setting allows including (or limiting) -1 (all) to 1000 (maximum) posts.",'theme_admin'),
						"id" => "superlink_max_portfolios",
						"default" => '-1',
						"min" => -1,
						"max" => 1000,
						"step" => "1",
					...
					array(
						"name" => __("Order Portfolio Post By",'theme_admin'),
						"desc" => __("<p align='justify'>Select and set the portfolio post sorting order for how they appear in a superlink. The options are by date, id, title, date modified or Author. You should be aware that choosing any option other then Date Created will result in an ordering that will not necessarily have the most recent posts appearing in the Superlink.  But if you have say a multi-author website and have given users editor or unique priveleges (User Role Editor Plugin) then other sort orders could be very applicable.</p>",'theme_admin'),	
						"id" => "superlink_orderby_portfolios",
						"default" => 'title',
						"options" => array(
							"date" => __('Date Created','theme_admin'),
							"ID" => __('ID','theme_admin'),
					...
					array(
						"name" => __("Ascending or Descending Portfolio Sort",'theme_admin'),
						"desc" => __("<p align='justify'>You can choose ASC or DESC. Note when set to DESC and Portfolio Order By is set to Date the Superlink Select Dropdown list with portfolio items is starting from the Last One Created. When set to ASC and  Order By to Date the Superlink Select Dropdown will list the Portfolio items starting from the most recent Portfolio item created.</p>",'theme_admin'),	
						"id" => "superlink_order_portfolios",
						"default" => 'ASC',
						"options" => array(
							"DESC" => __('Descending','theme_admin'),
							"ASC" => __('Ascending','theme_admin'),
	...
	function _option_install_dummy_data_function($value, $default) {
		...
		if ($max_time<120) {
			$max_time_message=sprintf(__("Max Execution Time is set at : %s &nbsp;&nbsp;Click on the + sign for more instructions.",'theme_admin'),$max_time);
			echo '<div class="theme-message theme-message-info updated" style="width:auto;border-left-color: #ff0000;"><p><strong>'.$max_time_message.'</strong></p></div>';
		}
