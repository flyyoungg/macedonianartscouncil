...
function theme_update($from, $to) {
	...
	$zip_file = $to . 'cache/backup/'.THEME_VERSION.'_'.$theme_version.'.zip';
	$wp_filesystem->put_contents($zip_file,file_get_contents($tempfile),FS_CHMOD_FILE);
	unlink($tempfile);
