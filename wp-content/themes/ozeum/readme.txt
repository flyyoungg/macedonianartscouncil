...
WordPress version: required at least 4.7, tested up to 5.3
...
Please install and activate it before starting to use the theme Ozeum.
...
Theme documentation is available on http://ozeum.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Ozeum is Fontello.
