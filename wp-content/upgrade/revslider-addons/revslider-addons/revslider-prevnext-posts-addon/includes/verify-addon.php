...
class Revslider_Prev_Next_Addon_Verify {
	
	private $notice = false,
			$min_rev_slider = '6.0',
			$addon_title = 'Previous and Next Posts',
			$text_domain = 'revslider-prevnext-posts-addon',
			$notice_slug = 'revslider_prevnext_posts_addon';
	...
	public function enqueue_notice_script() {
		...
		wp_enqueue_script($this->text_domain . '-notice', REV_ADDON_PREVNEXT_POSTS_URL . 'admin/assets/js/dismiss-admin-notice.js', array('jquery'), REV_ADDON_PREVNEXT_POSTS_VERSION, true);
