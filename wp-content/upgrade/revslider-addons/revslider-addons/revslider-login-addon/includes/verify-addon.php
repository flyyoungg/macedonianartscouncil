...
class Revslider_Login_Addon_Verify {
	
	private $notice = false,
			$min_rev_slider = '6.0',
			$addon_title = 'Login Page',
			$text_domain = 'revslider-login-addon',
			$notice_slug = 'revslider_login_addon';
	...
	public function enqueue_notice_script() {
		...
		wp_enqueue_script($this->text_domain . '-notice', REV_ADDON_LOGIN_URL . 'admin/assets/js/dismiss-admin-notice.js', array('jquery'), REV_ADDON_LOGIN_VERSION, true);
