...
class Revslider_Related_Posts_Addon_Verify {
	
	private $notice = false,
			$min_rev_slider = '6.0',
			$addon_title = 'Related Posts',
			$text_domain = 'revslider-rel-posts-addon',
			$notice_slug = 'revslider_rel_posts_addon';
	...
	public function enqueue_notice_script() {
		...
		wp_enqueue_script($this->text_domain . '-notice', REV_ADDON_REL_POSTS_URL . 'admin/assets/js/dismiss-admin-notice.js', array('jquery'), REV_ADDON_REL_POSTS_VERSION, true);
