				...
				"params" => array_merge(
					array(
						...
						array(
							...
							"description" => wp_kses_data( __("Select the sorting type for properties list", 'trx_addons') ),
							"std" => "date",
							'save_always' => true,
						...
						array(
							...
							"description" => wp_kses_data( __("Select the sorting order for properties list", 'trx_addons') ),
							"std" => "desc",
							'save_always' => true,
