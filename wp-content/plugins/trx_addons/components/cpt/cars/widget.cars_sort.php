...
class trx_addons_widget_cars_sort extends TRX_Addons_Widget {
	...
	function form($instance) {
		...
		do_action('trx_addons_action_before_widget_fields', $instance, 'trx_addons_widget_cars_sort', $this);
		...
		do_action('trx_addons_action_after_widget_title', $instance, 'trx_addons_widget_cars_sort', $this);
		...
		do_action('trx_addons_action_after_widget_fields', $instance, 'trx_addons_widget_cars_sort', $this);
	}
}
