...
if ( !function_exists( 'trx_addons_widget_custom_links_load_scripts_front' ) ) {
	add_action("wp_enqueue_scripts", 'trx_addons_widget_custom_links_load_scripts_front');
	function trx_addons_widget_custom_links_load_scripts_front() {
...
if ( !function_exists( 'trx_addons_widget_custom_links_merge_styles' ) ) {
	...
	function trx_addons_widget_custom_links_merge_styles($list) {
		$list[] = TRX_ADDONS_PLUGIN_WIDGETS . 'custom_links/custom_links.css';
		return $list;
	}
}
