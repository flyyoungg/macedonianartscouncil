...
if ( !function_exists( 'trx_addons_edd_load_responsive_styles' ) ) {
	add_action("wp_enqueue_scripts", 'trx_addons_edd_load_responsive_styles', 2000);
	function trx_addons_edd_load_responsive_styles() {
		if ( trx_addons_exists_edd() && trx_addons_is_on(trx_addons_get_option('debug_mode'))) {
			wp_enqueue_style( 'trx_addons-edd-responsive', trx_addons_get_file_url(TRX_ADDONS_PLUGIN_API . 'easy-digital-downloads/easy-digital-downloads.responsive.css'), array(), null );
		}
	}
}
...
if ( !function_exists( 'trx_addons_edd_merge_styles' ) ) {
	...
	function trx_addons_edd_merge_styles($list) {
		if ( trx_addons_exists_edd() ) {
			$list[] = TRX_ADDONS_PLUGIN_API . 'easy-digital-downloads/easy-digital-downloads.css';
		}
		return $list;
	}
}
...
if ( !function_exists( 'trx_addons_edd_merge_styles_responsive' ) ) {
	...
	function trx_addons_edd_merge_styles_responsive($list) {
		if ( trx_addons_exists_edd() ) {
			$list[] = TRX_ADDONS_PLUGIN_API . 'easy-digital-downloads/easy-digital-downloads.responsive.css';
		}
		return $list;
	}
}
