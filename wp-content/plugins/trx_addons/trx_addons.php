...
// Current version
if ( ! defined( 'TRX_ADDONS_VERSION' ) ) define( 'TRX_ADDONS_VERSION', '1.70.3.3' );
...
if ( !function_exists( 'trx_addons_load_scripts_admin' ) ) {
	...
	function trx_addons_load_scripts_admin($all=false) {
        ...
        // Load RTL styles
        if ( is_rtl() ) {
            wp_enqueue_style( 'trx_addons-admin-rtl', trx_addons_get_file_url( 'css/trx_addons.admin.rtl.css' ), array('trx_addons-admin'), null );
        }
