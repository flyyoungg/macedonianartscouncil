...
class Form_Meta {
	...
	public function add_metaboxes( $post_type ) {
		add_meta_box( 'form-configuration', __( 'Form Configuration', 'simply-static-pro' ), array( $this, 'render_form_configuration' ), 'ssp-form', 'normal', 'high' );
	}
		...
		<div class="ssp-meta ssp-admin">
			<div>
					...
					<select name="tool" id="tool">
						<?php foreach ( $tools as $tool => $name ) : ?>
							<?php if ( $meta_fields['tool'] == $tool ) : ?>
								<option selected="selected" value="<?php echo esc_attr( $tool ); ?>"><?php echo esc_html( $name ); ?></option>
							<?php else : ?>
				...
				<p>
					...
					<input id="form-id" name="form-id" type="number" value="<?php echo esc_html( $meta_fields['form-id'] ); ?>">
				...
				<p>
					...
					<input id="subject" name="subject" type="text" value="<?php echo esc_html( $meta_fields['subject'] ); ?>">
				...
				<p>
					...
					<input id="name-attributes" name="name-attributes" type="text" value="<?php echo esc_html( $meta_fields['name-attributes'] ); ?>">
				...
				<p>
					...
					<textarea rows="10" cols="15" id="message" name="message" placeholder="<p>Thanks for your message. Here are your details:</p>&#10;&#10;<p>First Name: your-name</p>&#10;<p>E-Mail: your-email</p>"><?php echo esc_textarea( $meta_fields['message'] ); ?></textarea>
			...
			<div>
				<p>
					...
					<input id="email" name="email" type="email" value="<?php echo esc_html( $meta_fields['email'] ); ?>" placeholder="mail@domain.com">
				...
				<p>
					...
					<input id="additional-headers" name="additional-headers" type="text" placeholder="Cc: cc@domain.com,Bcc: bcc@domain.com" value="<?php echo esc_html( $meta_fields['additional-headers'] ); ?>">
				...
				<p>
					...
					<input id="endpoint" name="endpoint" type="url" value="<?php echo esc_html( $meta_fields['endpoint'] ); ?>" placeholder="<?php echo esc_url( get_bloginfo( 'url' ) ); ?>">
					...
					<p class="description"><b><?php esc_html_e( 'Simply Static Endpoint', 'simply-static-pro' ); ?>:</b> <code><?php echo esc_url( get_bloginfo( 'url' ) ); ?>?mailme</code></p>
				</p>
				<p>
					<span><?php esc_html_e( 'Redirect URL', 'simply-static-pro' ); ?></span><br>
					<input id="redirect-url" name="redirect-url" type="url" value="<?php echo esc_html( $meta_fields['redirect-url'] ); ?>" placeholder="<?php echo esc_url( get_bloginfo( 'url' ) ); ?>">
