 ...
 * @since 1.0
 */
class Swp_Timeline_Style_Blog_One extends Widget_Base
{

    public function get_name()
    {
        return 'swp-timeline-blog-one';
    }

    public function get_title()
    {
        return esc_html__('Blog Style One', 'swp-timeline');
    }
    ...
    protected function render()
    {
        ...
        include swp_timeline_get_template('blog-style-one-layout-one.php');
        include swp_timeline_get_template('blog-style-one-layout-two.php');
        include swp_timeline_get_template('blog-style-one-layout-three.php');
    }
}

plugin::instance()->widgets_manager->register(new Swp_Timeline_Style_Blog_One());
