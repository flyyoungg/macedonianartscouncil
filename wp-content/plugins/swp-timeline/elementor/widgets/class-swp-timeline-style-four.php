 ...
 * @since 1.0
 */
class Swp_Timeline_Style_four extends Widget_Base
{

    public function get_name()
    {
        return 'swp-timeline-four';
    }

    public function get_title()
    {
        return esc_html__('Style Four', 'swp-timeline');
    }
    ...
    protected function _register_controls()
    {
        ...
        $layout_two_timeline->add_control(
            ...
            [
                'label' => esc_html__('Short Month ', 'swp-timeline'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'placeholder' => esc_html__('Add Short Date ', 'swp-timeline'),
                'default' => esc_html__('Jan', 'swp-timeline'),
                'label_block' => true
            ]
        );
    ...
    protected function render()
    {
        ...
        include swp_timeline_get_template('style-four-layout-one.php');
        include swp_timeline_get_template('style-four-layout-two.php');
        include swp_timeline_get_template('style-four-layout-three.php');
    }
}

plugin::instance()->widgets_manager->register(new Swp_Timeline_Style_four());