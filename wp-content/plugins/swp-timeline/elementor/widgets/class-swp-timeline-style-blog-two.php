 ...
 * @since 1.0
 */
class Swp_Timeline_Style_Blog_Two extends Widget_Base
{

    public function get_name()
    {
        return 'swp-timeline-blog-Two';
    }

    public function get_title()
    {
        return esc_html__('Blog Style Two', 'swp-timeline');
    }
    ...
    protected function render()
    {
        ...
        include swp_timeline_get_template('blog-style-two-layout-one.php');
        include swp_timeline_get_template('blog-style-two-layout-two.php');
        include swp_timeline_get_template('blog-style-two-layout-three.php');
    }
}

plugin::instance()->widgets_manager->register(new Swp_Timeline_Style_Blog_Two());
